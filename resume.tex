...
\noindent \hangindent=1em \hangafter=0 \textbf{MS}, Computer Science, Courant Institute of Mathematical Sciences, New York University. --- CGPA\@: 3.75 --- Expected Dec, 2016\\
...
Automated routine tasks using \textbf{Perl} scripts.  I also built a \textbf{RPC} framework for spam filtering.
